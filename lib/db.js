...
const STANDAARD = [
  ...
  ['facebook_url', 'https://www.facebook.com/klusspecialistvanduijn/', 'Link naar uw Facebook-pagina', 'Zo weet Google dat die pagina bij hetzelfde bedrijf hoort. Leeg laten mag.', 'regel', 'google', 40],
  ['werkspot_url', 'https://www.werkspot.nl/profiel/de-klusspecialist-van-duijn', 'Link naar uw Werkspot-profiel', 'Daar staan uw reviews. Google koppelt die aan uw bedrijf. Leeg laten mag.', 'regel', 'google', 50],
  ['instagram_url', 'https://www.instagram.com/klusspecialistvanduijn/', 'Link naar uw Instagram', 'Bijvoorbeeld https://www.instagram.com/uwnaam. Leeg laten mag.', 'regel', 'google', 60],
  ...
  ['reviews_tekst', '4,8 uit 59 beoordelingen op Werkspot', 'Reviewregel bij Over ons', 'Verschijnt met sterretjes erbij en linkt naar uw Werkspot-profiel. Werk het aantal bij als er reviews bijkomen. Leeg laten haalt de regel van de site.', 'regel', 'over', 80],
